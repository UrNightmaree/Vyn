...
src: https://github.com/weshoke/Lust
Modified Lust with some minor fixes 
...
local succ, lpeg = pcall(require, "lpeg")
if not succ then
    local lulpeg
    succ, lulpeg = pcall(require, "lulpeg")

    if not succ then
        error('\n'..lpeg.."\n\n"..lulpeg)
    else lpeg = lulpeg end
end
